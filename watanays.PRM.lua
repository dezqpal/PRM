...
local title = ("PRM || PRVT SCRIPT - WSP!!!  %s"):format(displayName)

local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/dezqpal/PRM/refs/heads/main/PRM.ui.LUA "))()

local window = library:AddWindow(title, {
    main_color = Color3.fromRGB(0, 0, 0),
    min_size = Vector2.new(420, 390),
    can_resize = true,
})
...
FastRebTab:AddButton("Full Optimization", function()
    local player = game.Players.LocalPlayer
    local playerGui = player:WaitForChild("PlayerGui")
    local lighting = game:GetService("Lighting")
...
local miscLabel = FastRebTab:AddLabel("Thing:")
...
local FarmingTab = window:AddTab("Fast Strength")
...
FarmingTab:AddLabel("")
FarmingTab:AddLabel("Fast Farm (Adjust rep cycle- 20 | 40 | 50)").TextSize = 20
...
FarmingTab:AddLabel("things:").TextSize = 20
...
FarmingTab:AddSwitch("Auto Eat betlog 30 Minuts", function(state)
...
MainTab:AddLabel("thing:").TextSize = 22
...
local Gift = window:AddTab("A•Gift")
...
Gift:AddTextBox("Tropical Shakes Gift Amount", function(text)
...
Credits:AddLabel("      ")
Credits:AddLabel("Inspired By pepapig")
Credits:AddLabel("Script Made By||Primo:")
Credits:AddLabel("   ")

Credits:AddLabel("â€¢--- My Social Media ---â€¢")
...
TimerLabel.Size = UDim2.new(0, 200, 0, 15)
...
TimerLabel.Text = "Anti AFK: 00:00"
...
task.spawn(function()
    ...
    while true do
        ...
        TimerLabel.Text = string.format("Anti AFK: %02d:%02d", mins, secs)
    end
end)
